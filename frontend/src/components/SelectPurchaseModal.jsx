...
export default function SelectPurchaseModal({ product, open, onClose }) {
  ...
  const hasDiscount = product.discount > 0 && product.finalPrice !== undefined && product.originalPrice !== undefined;
  const displayPrice = hasDiscount ? product.finalPrice : product.price;
  const displayOriginalPrice = hasDiscount ? product.originalPrice : null;
