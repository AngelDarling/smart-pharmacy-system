        ...
        <div style={{ 
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
               ...
               <Link to="/stores" onClick={handleLinkClick} style={{ color: '#3b82f6', textDecoration: 'none', fontSize: 14 }}>
                 Hệ thống cửa hàng
               </Link>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
               ...
               <Link to="/news" onClick={handleLinkClick} style={{ color: '#3b82f6', textDecoration: 'none', fontSize: 14 }}>
                 Tin tức sức khỏe
               </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ 
              ...
              {['Visa', 'Mastercard', 'JCB', 'MoMo', 'VNPay', 'ZaloPay'].map((method) => (
